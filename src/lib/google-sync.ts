...
export async function syncGoogleKeywords(
  customerId: string,
  fromDate: string,
  toDate: string
  ...
  try {
    ...
    const rows: GoogleKeywordRow[] = results.map((r: any) => ({
      customer_id: customerId,
      campaign_name: r.campaign.name || '',
...
export async function syncGoogleSearchTerms(
  customerId: string,
  fromDate: string,
  toDate: string
  ...
  try {
    ...
    const rows: GoogleSearchTermRow[] = results.map((r: any) => ({
      customer_id: customerId,
      campaign_name: r.campaign.name || '',
      ad_group_name: r.ad_group.name || '',
